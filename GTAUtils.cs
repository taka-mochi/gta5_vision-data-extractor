...
namespace gta5_vision_data_extractor
{
    public class GTAUtils
    {
        ...
        /// <summary>
        /// Pedestrian bone ids (from https://github.com/crosire/scripthookvdotnet/blob/dev_v3/source/scripting/World/Entities/Peds/BoneID.cs)
        /// </summary>
        public enum PedBone
        {
            SKEL_ROOT = 0x0,
        ...
        /// <returns></returns>
        public static BoundingBox2D ComputeBoundingBox(Entity entity, bool check_by_ped_bones = false)
        {
            var model = entity.Model;

            // 3D bb corners
            Vector3[] check_points = null;

            if (check_by_ped_bones)
            {
                // convert by bone positions
